...
public class ReviewSelection extends AbstractSelection<ReviewSelection> {
    ...
    public ReviewSelection moviedbId(String... value) {
        addEquals(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection moviedbIdNot(String... value) {
        addNotEquals(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection moviedbIdLike(String... value) {
        addLike(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection moviedbIdContains(String... value) {
        addContains(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection moviedbIdStartsWith(String... value) {
        addStartsWith(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection moviedbIdEndsWith(String... value) {
        addEndsWith(ReviewColumns.MOVIEDB_ID, value);
        return this;
    }

    public ReviewSelection orderByMoviedbId(boolean desc) {
        orderBy(ReviewColumns.MOVIEDB_ID, desc);
        return this;
    }

    public ReviewSelection orderByMoviedbId() {
        orderBy(ReviewColumns.MOVIEDB_ID, false);
        return this;
    }
